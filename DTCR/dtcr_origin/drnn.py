...
def dRNN(cell, inputs, rate, scope='default'):
    ...
    print("Building layer: {}, input length: {}, dilation rate: {}, input dim: {}.".format(scope, n_steps, rate, inputs[0].get_shape()[1]))
    ...
    if not EVEN:
        ...
        print("=====> {} time points need to be padded. ".format(dialated_n_steps * rate - n_steps))
        print("=====> Input length for sub-RNN: {}".format(dialated_n_steps))
