...
class InjectAnomalies:
    ...
    def inject_anomalies(self,
        ...
        ano_num_cols = ano_num_cols - np.max([ano_num_cols.min(), self.ano_col_rate]) <= 0.001 # To reduce the situation where no columns are modified
